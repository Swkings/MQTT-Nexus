    ...
    <div className="select-none">
      <div 
        className={cn(
          ...
          theme.mode === 'light' ? "hover:bg-slate-200" : "hover:bg-slate-800/50",
          isSelected 
      ...
      >
        ...
        >
          {hasChildren ? (
            expanded ? <ChevronDown className={cn("w-3.5 h-3.5", themeClasses.textSecondary)} /> : <ChevronRight className={cn("w-3.5 h-3.5", themeClasses.textSecondary)} />
          ) : <span className="w-3.5 h-3.5" />}
        </div>
        
        {hasChildren ? (
          expanded ? <FolderOpen className={cn("w-4 h-4 shrink-0", theme.mode === 'light' ? "text-purple-600" : "text-purple-400")} /> : <Folder className={cn("w-4 h-4 shrink-0", theme.mode === 'light' ? "text-purple-600" : "text-purple-400")} />
        ) : (
        ...
        {displayCount > 0 && onAddToFavorites && (
          <button
            ...
            className={cn(
              ...
              theme.mode === 'light' ? "text-slate-400 hover:text-cyan-600" : "text-slate-500 hover:text-cyan-400"
            )}
